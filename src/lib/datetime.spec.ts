...
describe('Should return formatted the date', () => {
	...
	it('Should format duration seconds to course duration', () => {
		...
		map.set(28799, '1 day 59 minutes')
		map.set(28800, '1 day 1 hour')
		map.set(28801, '1 day 1 hour')
		map.set(28860, '1 day 1 hour 1 minute')
		map.set(32400, '1 day 2 hours')
		map.set(32461, '1 day 2 hours 1 minute')
		map.set(57599, '2 days 1 hour 59 minutes')
		map.set(57600, '2 days 2 hours')
		for (const [duration, output] of map.entries()) {
