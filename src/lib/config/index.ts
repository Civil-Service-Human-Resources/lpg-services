...
export const HOMEPAGE_COMPLETE_REQUIRED_COURSES = env.HOMEPAGE_COMPLETE_REQUIRED_COURSES || 'false'

export const HOMEPAGE_COMPLETE_LEARNING_PLAN_COURSES = env.HOMEPAGE_COMPLETE_LEARNING_PLAN_COURSES || 'false'
