...
describe('NotificationService tests', () => {
	...
	it('should send email', async () => {
		...
		const result = await notificationService.sendEmail(templateId, email, personalisation, accessToken)
	...
	it('should catch error', async () => {
		...
		expect(
			notificationService.sendEmail(templateId, email, personalisation, accessToken)
